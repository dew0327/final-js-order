...
public class Order {
    ...
    public void onPostPersist(){
        ...
        if(!"ORDER : COOK CANCELED".equals(ordered.getStatus())){
            ...
            /*수정*/
            myProject_LSP.external.Point point = new myProject_LSP.external.Point();
            point.setOrderId(this.getId());
            point.setStatus("ORDER : point SEND");

            OrderApplication.applicationContext.getBean(myProject_LSP.external.PointService.class).pointSend(point);
        }
